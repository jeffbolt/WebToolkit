...
<asp:Panel ID="divSparkline" runat="server">
	<%--<div class="text-right hide-lg hide-md hide-sm hide-xs mt-2"></div>--%>
    <asp:Label ID="tooltip" CssClass="d-inline-block tooltipped tooltipped-s" runat="server">
        <svg id="svg" runat="server" width="155" height="30">
            <defs>
				<linearGradient id="gradient" runat="server" x1="0" x2="0" y1="1" y2="0">
					<stop offset="10%" stop-color="<%= GradientColors[0] %>"></stop>
					<stop offset="33%" stop-color="<%= GradientColors[1] %>"></stop>
					<stop offset="66%" stop-color="<%= GradientColors[2] %>"></stop>
					<stop offset="90%" stop-color="<%= GradientColors[3] %>"></stop>
				</linearGradient>
